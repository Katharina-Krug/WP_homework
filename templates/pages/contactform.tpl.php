<?php
   $re = '/^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/';
    ...
    if(isset($_POST["fname"]) && isset($_POST["lname"]) && isset($_POST["email"]) && isset($_POST["message"]) && !preg_match($re,$_POST['email']) && empty($_POST['fname'])&& empty($_POST['lname']) && empty($_POST['email']) && empty($_POST['message']))
    {
        ...
        $newentry = "<br>First name: ".$_POST["fname"]."<br>Last name: ".$_POST["lname"]."<br>Email: ".$_POST["email"]."<br>Message: ".$_POST["message"];
        // not first time entering input
       if (isset($_SESSION["lastInput"]) && $_SESSION["lastInput"]!=""){
            $outout= "<h2>You received the following from the contact form:</h2>".$newentry.$_SESSION["lastInput"];
        ...
        //first time entering input
            ...
            $_SESSION["lastInput"] = "<br>First name: ".$_POST["fname"]."<br>Last name: ".$_POST["lname"]."<br>Email: ".$_POST["email"]."<br>Message: ".$_POST["message"];
        }
...
<a href="/Web Programming/Homework/index.php">Back to Home</a>